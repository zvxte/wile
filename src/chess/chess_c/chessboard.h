...
Status_t chessboard_convert_san_to_uci(Chessboard_t *chessboard, char *san_move, char *uci_move);
Status_t chessboard_convert_uci_to_san(Chessboard_t *chessboard, char *uci_move, char *san_move);
